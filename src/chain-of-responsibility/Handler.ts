export default abstract class Handler {
    ...
    protected displayResult(title: string, content: string): void {
        const domLayout = document.createElement('div') as HTMLDivElement
        const domTitle = document.createElement('div') as HTMLDivElement
        const domContent = document.createElement('div') as HTMLDivElement
